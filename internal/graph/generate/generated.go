...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.todo":
		...
		return e.complexity.Query.Todo(childComplexity, args["_id"].(string)), true
...
`, BuiltIn: false},
	{Name: "../schemas/Enum.graphql", Input: `enum UserStatus {
  ACTIVE
  PENDING
}
`, BuiltIn: false},
...
`, BuiltIn: false},
	{Name: "../schemas/Response.graphql", Input: `type Response {
  isSuccess: Boolean
  message: String
}`, BuiltIn: false},
...
func (ec *executionContext) dir_auth_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["roles"]; ok {
		...
		arg0, err = ec.unmarshalORole2ᚕᚖassignmentᚋinternalᚋmodelᚐRole(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_todo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Todo)
	fc.Result = res
	return ec.marshalOTodo2ᚖassignmentᚋinternalᚋmodelᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputUserInput(ctx context.Context, obj interface{}) (model.UserInput, error) {
	...
	fieldsInOrder := [...]string{"name", "email", "phone", "sex", "avatar", "date_of_birth", "roles", "status", "password", "createdAt"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalORole2ᚕᚖassignmentᚋinternalᚋmodelᚐRole(ctx context.Context, v interface{}) ([]*model.Role, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []interface{}
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalORole2ᚖassignmentᚋinternalᚋmodelᚐRole(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) marshalORole2ᚕᚖassignmentᚋinternalᚋmodelᚐRole(ctx context.Context, sel ast.SelectionSet, v []*model.Role) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalORole2ᚖassignmentᚋinternalᚋmodelᚐRole(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) unmarshalORole2ᚖassignmentᚋinternalᚋmodelᚐRole(ctx context.Context, v interface{}) (*model.Role, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalORole2ᚖassignmentᚋinternalᚋmodelᚐRole(ctx context.Context, sel ast.SelectionSet, v *model.Role) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
...
func (ec *executionContext) marshalOTodo2ᚖassignmentᚋinternalᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v *model.Todo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Todo(ctx, sel, v)
